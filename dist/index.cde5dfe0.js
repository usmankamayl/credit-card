...
})({"lMoc9":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
const createCardFront = ()=>{
    ...
    const cardBack = _redom.el('div', {
        className: 'back'
    });
    cardBack.insertAdjacentHTML('beforeend', '<svg version="1.1" id="cardback" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"\n          x="0px" y="0px" viewBox="0 0 750 471" style="enable-background:new 0 0 750 471;" xml:space="preserve">\n          <g id="Front">\n            <line class="st0" x1="35.3" y1="10.4" x2="36.7" y2="11"/>\n          </g>\n          <g id="Back">\n            <g id="Page-1_2_">\n              <g id="amex_2_">\n                <path id="Rectangle-1_2_" class="darkcolor greydark" d="M40,0h670c22.1,0,40,17.9,40,40v391c0,22.1-17.9,40-40,40H40c-22.1,0-40-17.9-40-40V40\n          C0,17.9,17.9,0,40,0z"/>\n              </g>\n            </g>\n            <rect y="61.6" class="st2" width="750" height="78"/>\n            <g>\n              <path class="st3" d="M701.1,249.1H48.9c-3.3,0-6-2.7-6-6v-52.5c0-3.3,2.7-6,6-6h652.1c3.3,0,6,2.7,6,6v52.5\n                    C707.1,246.4,704.4,249.1,701.1,249.1z"/>\n              <rect x="42.9" y="198.6" class="st4" width="664.1" height="10.5"/>\n              <rect x="42.9" y="224.5" class="st4" width="664.1" height="10.5"/>\n              <path class="st5" d="M701.1,184.6H618h-8h-10v64.5h10h8h83.1c3.3,0,6-2.7,6-6v-52.5C707.1,187.3,704.4,184.6,701.1,184.6z"/>\n            </g>\n            <text transform="matrix(1 0 0 1 621.999 227.2734)" id="svgsecurity" class="st6 st7">985</text>\n            <g class="st8">\n              <text transform="matrix(1 0 0 1 518.083 280.0879)" class="st9 st6 st10">security code</text>\n            </g>\n            <rect x="58.1" y="378.6" class="st11" width="375.5" height="13.5"/>\n            <rect x="58.1" y="405.6" class="st11" width="421.7" height="13.5"/>\n            <text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" class="st12 st13">\u0418\u0432\u0430\u043D \u0418\u0432\u0430\u043D\u043E\u0432</text>\n          </g>\n        </svg>');
    cardFront.insertAdjacentHTML('beforeend', ` <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
          x="0px" y="0px" viewBox="0 0 750 471" style="enable-background:new 0 0 750 471;" xml:space="preserve">
          <g id="Front">
            <g id="CardBackground">
              <g id="Page-1_1_">
    ...
    return creditcard.append(cardFront, cardBack);
};
createCardFront();
...
const cleave = new _cleaveJsDefault.default(expirationdate, {
    date: true,
    dateMin: '18-01',
    dateMax: '28-12',
    datePattern: [
...
const cardValidate = new _cleaveJsDefault.default(cardnumber, {
    creditCard: true,
    delimiter: '-',
...
securitycode.addEventListener('input', ()=>{
    ...
    securitycode.value = securitycode.value.replace(/\D/g, '').substr(0, 3);
    document.getElementById('svgsecurity').textContent = securitycode.value;
});

},{"redom":"iahd6","cleave.js":"dYrzx","@parcel/transformer-js/src/esmodule-helpers.js":"inw7E"}],"iahd6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"inw7E"}],"inw7E":[function(require,module,exports) {
...
Cleave.prototype = {
    ...
    copyClipboardData: function(e) {
        ...
        if (!pps.copyDelimiter) textToCopy = Util2.stripDelimiters(inputValue, pps.delimiter, pps.delimiters);
    ...
    onInput: function(value) {
        var owner = this, pps = owner.properties, Util3 = Cleave.Util;
        // case 1: delete one more character "4"
        // 1234*| -> hit backspace -> 123|
        // case 2: last character is not delimiter which is:
        // 12|34* -> hit backspace -> 1|34*
        // note: no need to apply this for numeral mode
        var postDelimiterAfter = Util3.getPostDelimiter(value, pps.delimiter, pps.delimiters);
        if (!pps.numeral && pps.postDelimiterBackspace && !postDelimiterAfter) value = Util3.headStr(value, value.length - pps.postDelimiterBackspace.length);
        // phone formatter
        if (pps.phone) {
        ...
        // strip delimiters
        value = Util3.stripDelimiters(value, pps.delimiter, pps.delimiters);
        // strip prefix
        value = Util3.getPrefixStrippedValue(value, pps.prefix, pps.prefixLength, pps.result, pps.delimiter, pps.delimiters, pps.noImmediatePrefix, pps.tailPrefix, pps.signBeforePrefix);
        // strip non-numeric characters
        value = pps.numericOnly ? Util3.strip(value, /[^\d]/g) : value;
        // convert case
        ...
        value = Util3.headStr(value, pps.maxLength);
        // apply blocks
        pps.result = Util3.getFormattedValue(value, pps.blocks, pps.blocksLength, pps.delimiter, pps.delimiters, pps.delimiterLazyShow);
        owner.updateValueState();
    },
    updateCreditCardPropsByValue: function(value) {
        var owner = this, pps = owner.properties, Util4 = Cleave.Util, creditCardInfo;
        // At least one of the first 4 characters has changed
        if (Util4.headStr(pps.result, 4) === Util4.headStr(value, 4)) return;
        creditCardInfo = Cleave.CreditCardDetector.getInfo(value, pps.creditCardStrictMode);
        pps.blocks = creditCardInfo.blocks;
        pps.blocksLength = pps.blocks.length;
        pps.maxLength = Util4.getMaxLength(pps.blocks);
    ...
    updateValueState: function() {
        var owner = this, Util5 = Cleave.Util, pps = owner.properties;
        if (!owner.element) return;
        var endPos = owner.element.selectionEnd;
        var oldValue = owner.element.value;
        var newValue = pps.result;
        endPos = Util5.getNextCursorPosition(endPos, oldValue, newValue, pps.delimiter, pps.delimiters);
        // fix Android browser type="text" input field
        // cursor not jumping issue
        if (owner.isAndroid) {
            window.setTimeout(function() {
                owner.element.value = newValue;
                Util5.setSelection(owner.element, endPos, pps.document, false);
    ...
    getRawValue: function() {
        var owner = this, pps = owner.properties, Util6 = Cleave.Util, rawValue = owner.element.value;
        if (pps.rawValueTrimPrefix) rawValue = Util6.getPrefixStrippedValue(rawValue, pps.prefix, pps.prefixLength, pps.result, pps.delimiter, pps.delimiters, pps.noImmediatePrefix, pps.tailPrefix, pps.signBeforePrefix);
        if (pps.numeral) rawValue = pps.numeralFormatter.getRawValue(rawValue);
        else rawValue = Util6.stripDelimiters(rawValue, pps.delimiter, pps.delimiters);
        return rawValue;
    },
    getISOFormatDate: function() {
        var owner = this, pps = owner.properties;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"inw7E"}]},["lMoc9","jUTag"], "jUTag", "parcelRequire7fc0")
